    ...
    extend: {
      ...
      colors: {
        ...
        primary: {
          ...
          0: 'rgba(var(--semi-brand-0),1)',
          1: 'rgba(var(--semi-brand-1),1)',
          2: 'rgba(var(--semi-brand-2),1)',
          3: 'rgba(var(--semi-brand-3),1)',
          4: 'rgba(var(--semi-brand-4),1)',
          5: 'rgba(var(--semi-brand-5),1)',
          6: 'rgba(var(--semi-brand-6),1)',
          7: 'rgba(var(--semi-brand-7),1)',
          8: 'rgba(var(--semi-brand-8),1)',
          9: 'rgba(var(--semi-brand-9),1)',
